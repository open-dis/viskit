    ...
    public viskitGraphAssemblyComponent(ViskitGraphAssemblyModel model, AssemblyViewFrame frame) {
        ...
        this.getGraphLayoutCache().setFactory(new DefaultCellViewFactory() {
            ...
            protected VertexView createVertexView(Object v) {
                ...
                } else if (v instanceof ViskitAssemblyPropertyListCell) {
                    view = new ViskitAssemblyPropertyListView(v);
                } else {
            ...
            protected EdgeView createEdgeView(Object e) {
                ...
                if (e instanceof ViskitAssemblyEdgeCell) {
                    ...
                    if (o instanceof SimEvListenerEdge) {
                        view = new ViskitAssemblySelectedEdgeView(e);
                    }
                } else {
        ...
        if (ch != null) {
            ...
            for (Object cell : ch) {
                if (cell instanceof ViskitAssemblyCircleCell) {
                    ...
                    ViskitAssemblyPropertyListCell plc = (ViskitAssemblyPropertyListCell) cell;
        ...
        if (event != null) {
            ...
            if (c != null) {
                ...
                if (c instanceof ViskitAssemblyEdgeCell) {
                    ...
                    sb.append("</html>");
                    return sb.toString();
                } else if (c instanceof ViskitAssemblyCircleCell || c instanceof ViskitAssemblyPropertyListCell) {
                    String typ;
                    String name;
                    String desc;
 ...
 * To mark our nodes.
 */
class ViskitAssemblyPropertyListCell extends DefaultGraphCell {

    public ViskitAssemblyPropertyListCell(Object userObject) {
        super(userObject);
    }
}

/**
 * Sub class VertexView to install our own viskitVertexRenderer.
 */
class ViskitAssemblyPropertyListView extends VertexView {

    // shared with ViskitAssemblyCircleView
    static ViskitVertexRenderer viskitVertexRenderer = new ViskitVertexRenderer();

    public ViskitAssemblyPropertyListView(Object cell) {
        super(cell);
    }

    @Override
    public CellViewRenderer getRenderer() {
        return viskitVertexRenderer;
    }
}
...
class ViskitAssemblyCircleView extends VertexView {
    ...
    @Override
    public CellViewRenderer getRenderer() {
        return ViskitAssemblyPropertyListView.viskitVertexRenderer;
    }
}
...
class ViskitAssemblyAdapterEdgeView extends vEdgeView {
    ...
    static ViskitAssemblyAdapterEdgeRenderer viskitAssemblyAdapterEdgeRenderer = new ViskitAssemblyAdapterEdgeRenderer();
    ...
    @Override
    public CellViewRenderer getRenderer() {
        return viskitAssemblyAdapterEdgeRenderer;
    }
}

/**
 * Sub class vEdgeView to install our own viskitAssemblyEdgeRenderer.
 */
class ViskitAssemblySelectedEdgeView extends vEdgeView {

    // shared with ViskitAssemblyPclEdgeView
    static ViskitAssemblyEdgeRenderer viskitAssemblyEdgeRenderer = new ViskitAssemblyEdgeRenderer();

    public ViskitAssemblySelectedEdgeView(Object cell) {
        super(cell);
    }

    @Override
    public CellViewRenderer getRenderer() {
        return viskitAssemblyEdgeRenderer;
    }
}

class ViskitAssemblyPclEdgeView extends vEdgeView {

    public ViskitAssemblyPclEdgeView(Object cell) {
        super(cell);
    }

    @Override
    public CellViewRenderer getRenderer() {
        return ViskitAssemblySelectedEdgeView.viskitAssemblyEdgeRenderer;
    }
}

class ViskitAssemblyAdapterEdgeRenderer extends viskitEdgeRenderer {

    /**
     * Paint the ViskitAssemblyAdapterEdgeRenderer. Overridden to do a double line and paint over the end
     * shape
     */
    @Override
...
class ViskitAssemblyEdgeRenderer extends viskitEdgeRenderer {

    @Override
    protected Shape createLineEnd(int size, int style, Point2D src, Point2D dst) {
        return ViskitAssemblyAdapterEdgeView.viskitAssemblyAdapterEdgeRenderer.createLineEnd(size, style, src, dst);
    }
}
