 ...
 * @version $Id$
 */
public class viskitEdgeRenderer extends EdgeRenderer {
    
    protected static final Logger LOG = LogUtils.getLogger(viskitEdgeRenderer.class);
