 ...
 * to properly identify constructors of Event Graph classes on the classpath whether
 ...
 * iconized Event Graphs, the Assembly can be constructed such that each Event Graph parameter is
